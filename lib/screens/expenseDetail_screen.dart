                            ...
                            child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: const [
                                      SizedBox(height: 20,),
                                      Text("Remove this transaction?",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600),),
                                      SizedBox(height: 20,),
                                      Text("Are you sure do you wanna remove this transaction?",textAlign: TextAlign.center,style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600,color: AppColors.textHintColor),),
                                    ],
                                  ),
                                )),
                          );
